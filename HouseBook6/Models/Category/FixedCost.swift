...
struct FixedCostFromFirestore {
    ...
    init(dic: [String: Any], month: Int) {
        if month == 1 || month == 2 || month == 3 || month == 4 || month == 5 || month == 6 || month == 7 || month == 8 || month == 9 {
            self.foodMoneyFromFirestore = dic["0\(month)食費固定費SumMoney"] as! Int?
            self.foodFixedCostSubCategoryArrayFromFirestore = dic["0\(month)食費固定費配列"] as! [String]?
            self.dailyGoodsMoneyFromFirestore = dic["0\(month)日用品固定費SumMoney"] as! Int?
            self.dailyGoodsFixedCostSubCategoryArrayFromFirestore = dic["0\(month)日用品固定費配列"] as! [String]?
            self.clothMoneyFromFirestore = dic["0\(month)服飾固定費SumMoney"] as! Int?
            self.clothFixedCostSubCategoryArrayFromFirestore = dic["0\(month)服飾固定費配列"] as! [String]?
            self.healthMoneyFromFirestore = dic["0\(month)健康固定費SumMoney"] as! Int?
            self.healthFixedCostSubCategoryArrayFromFirestore = dic["0\(month)健康固定費配列"] as! [String]?
            self.datingMoneyFromFirestore = dic["0\(month)交際固定費SumMoney"] as! Int?
            self.datingFixedCostSubCategoryArrayFromFirestore = dic["0\(month)交際固定費配列"] as! [String]?
            self.hobbiesMoneyFromFirestore = dic["0\(month)趣味固定費SumMoney"] as! Int?
            self.hobbiesFixedCostSubCategoryArrayFromFirestore = dic["0\(month)趣味固定費配列"] as! [String]?
            self.liberalArtsMoneyFromFirestore = dic["0\(month)教養固定費SumMoney"] as! Int?
            self.liberalArtsFixedCostSubCategoryArrayFromFirestore = dic["0\(month)教養固定費配列"] as! [String]?
            self.transportationMoneyFromFirestore = dic["0\(month)交通固定費SumMoney"] as! Int?
            self.transportationFixedCostSubCategoryArrayFromFirestore = dic["0\(month)交通固定費配列"] as! [String]?
            self.cosmetologyMoneyFromFirestore = dic["0\(month)美容固定費SumMoney"] as! Int?
            self.cosmetologyFixedCostSubCategoryArrayFromFirestore = dic["0\(month)美容固定費配列"] as! [String]?
            self.sightseeingMoneyFromFirestore = dic["0\(month)観光固定費SumMoney"] as! Int?
            self.sightseeingFixedCostSubCategoryArrayFromFirestore = dic["0\(month)観光固定費配列"] as! [String]?
            self.carMoneyFromFirestore = dic["0\(month)車固定費SumMoney"] as! Int?
            self.carFixedCostSubCategoryArrayFromFirestore = dic["0\(month)車固定費配列"] as! [String]?
            self.motorcycleMoneyFromFirestore = dic["0\(month)バイク固定費SumMoney"] as! Int?
            self.motorcycleFixedCostSubCategoryArrayFromFirestore = dic["0\(month)バイク固定費配列"] as! [String]?
            self.netWorkMoneyFromFirestore = dic["0\(month)通信固定費SumMoney"] as! Int?
            self.netWorkFixedCostSubCategoryArrayFromFirestore = dic["0\(month)通信固定費配列"] as! [String]?
            self.waterMoneyFromFirestore = dic["0\(month)水道代固定費SumMoney"] as! Int?
            self.waterFixedCostSubCategoryArrayFromFirestore = dic["0\(month)水道代固定費配列"] as! [String]?
            self.gasMoneyFromFirestore = dic["0\(month)ガス代固定費SumMoney"] as! Int?
            self.gasFixedCostSubCategoryArrayFromFirestore = dic["0\(month)ガス代固定費配列"] as! [String]?
            self.electricityMoneyFromFirestore = dic["0\(month)電気代固定費SumMoney"] as! Int?
            self.electricityFixedCostSubCategoryArrayFromFirestore = dic["0\(month)電気代固定費配列"] as! [String]?
            self.insuranceMoneyFromFirestore = dic["0\(month)保険固定費SumMoney"] as! Int?
            self.insuranceFixedCostSubCategoryArrayFromFirestore = dic["0\(month)保険固定費配列"] as! [String]?
            self.taxMoneyFromFirestore = dic["0\(month)税金固定費SumMoney"] as! Int?
            self.taxFixedCostSubCategoryArrayFromFirestore = dic["0\(month)税金固定費配列"] as! [String]?
            self.housingMoneyFromFirestore = dic["0\(month)住宅固定費SumMoney"] as! Int?
            self.housingFixedCostSubCategoryArrayFromFirestore = dic["0\(month)住宅固定費配列"] as! [String]?
            self.medicalMoneyFromFirestore = dic["0\(month)医療固定費SumMoney"] as! Int?
            self.medicalFixedCostSubCategoryArrayFromFirestore = dic["0\(month)医療固定費配列"] as! [String]?
            self.petMoneyFromFirestore = dic["0\(month)ペット固定費SumMoney"] as! Int?
            self.petFixedCostSubCategoryArrayFromFirestore = dic["0\(month)ペット固定費配列"] as! [String]?
        } else {
